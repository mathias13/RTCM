...
{
    public class Message_1006 : ISerialize
    {
        private uint _refId;
        ...
        public long AntennaHeight
        {
            get { return _antennaHeight; }
        }

        public double AntennaHeightMeters
        {
            get { return (double)_antennaHeight / 10000; }
        }
    }
}
